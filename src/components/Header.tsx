        ...
        <div className="flex items-center justify-between w-full md:w-auto">
          ...
          <div className="flex items-center gap-1.5 md:hidden">
            <button
              ...
              className="p-2 rounded-xl bg-blue-50 hover:bg-blue-100 text-blue-700 dark:bg-slate-900 dark:hover:bg-slate-800 dark:text-cyan-400 border border-blue-200 dark:border-slate-800 transition-all shadow-sm"
            >
              <Lock className="w-4 h-4 text-blue-700 dark:text-cyan-400" />
            </button>
            <button
              onClick={onToggleTheme}
              aria-label="Toggle Theme"
              className="p-2 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-800 dark:bg-slate-900 dark:hover:bg-slate-800 dark:text-slate-300 border border-slate-300 dark:border-slate-800 transition-all shadow-sm"
            >
            ...
            {userRole === 'ADMIN' && (
              <button
                ...
                className="p-2 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-800 dark:bg-slate-900 dark:hover:bg-slate-800 dark:text-slate-300 border border-slate-300 dark:border-slate-800 text-xs font-bold shadow-sm"
              >
                <Key className="w-4 h-4 text-slate-700 dark:text-cyan-400" />
              </button>
            )}
          </div>
        </div>
